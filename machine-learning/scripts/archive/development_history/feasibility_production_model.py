...
# =====================================================================
# Unified Feasibility Prediction Model
# =====================================================================
# This model takes a holistic approach to predicting housing feasibility
...
#
# 3. Risk Assessment:
#    - Natural hazards (flood, earthquake, storm surge)
#    - Risk scores and levels
#    - Instead of predicting risk separately, we use risk factors
#      as features to determine overall feasibility
#
# 4. Payment/Price Factors:
#    - Total contract price
#    - Monthly payments
#
# The model learns how these factors interact to determine feasibility,
# providing a more nuanced prediction than separate models would.
# =====================================================================
...
def load_and_prepare_data():
    ...
    risk_features = [
        ...
        "RISK_GroundShaking_Level_Num",  # Additional risk features
...
def create_pipeline(numeric_features, categorical_features):
    ...
    # Create full pipeline with unified feasibility prediction
    # This model learns feasibility by considering:
    # 1. Economic factors (income, GRDP)
    # 2. Market demand (households, units)
    # 3. Risk factors (flood, earthquake, etc.)
    # 4. Payment/Price factors
    pipeline = Pipeline([
        ('preprocessor', preprocessor),
        ('classifier', RandomForestClassifier(
            n_estimators=200,  # Increased for better learning of feature interactions
            max_depth=None,
            min_samples_split=2,
            min_samples_leaf=1,
            max_features='sqrt',  # Better generalization with more features
            random_state=42,
